...
class Message(object):
    ...
    def build_shift_dict(self, shift):
        ...
        for letter in lower_alpha:
            shift_dict[letter] = lower_alpha[(lower_alpha.find(letter) + shift) % 26]
        for letter in upper_alpha:
            shift_dict[letter] = upper_alpha[(upper_alpha.find(letter) + shift) % 26]
